...
{/* Missing-employees-varningen borttagen 2026-09-01 — data i systemet är inte
   komplett ännu och varningen gav mest brus. Endpointen finns kvar för
   framtida bruk men visas inte i UI. */}
